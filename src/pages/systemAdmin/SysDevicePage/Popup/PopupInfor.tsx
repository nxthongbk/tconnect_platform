...
import TabAlarmDevice from '../DrawerDevice/TabAlarm';
import TabAttributesDevice from '../DrawerDevice/TabAttributes';
import TabLastTelemetry from '../DrawerDevice/TabLastTelemetry';
import TabNotification from '~/pages/tenant/DevicePage/DrawerDevice/TenantView/TabNotification';
import TabsInforDevice from '../DrawerDevice/TabInfo';
...
export default function PopupDeviceInfor({ props }: { props: Record<string, any> }) {
        ...
        <Box sx={{ width: 1024 }} className='flex flex-col flex-1 gap-4 p-6' role='presentation'>
          ...
          <Box sx={{ borderBottom: 1, borderColor: 'divider', display: 'flex', justifyContent: 'space-between' }}>
            <Tabs value={value} onChange={handleChange} aria-label='basic tabs example'>
              <Tab label={translate('detail-info')} {...a11yProps(0)} />
