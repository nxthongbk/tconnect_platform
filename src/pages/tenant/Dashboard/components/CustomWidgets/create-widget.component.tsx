...
import { ChartBar, ChartDonut, ChartLine, ChartLineDown, Hash, Image, Plus, UploadSimple, Video } from '@phosphor-icons/react';
...
const CreateWidget: React.FC<CreateWidgetProps> = ({ handleSuccess, pageId, dashboard }) => {
  ...
  const renderFormCreateWidget = useMemo(() => {
    switch (selectedTemplate?.type) {
      ...
      case "camera":
        return <SelectCameras control={control} isError={!!errors.deviceId} helperText={errors?.deviceId?.message} locationId={dashboard?.location?.id} />
